...
export default function SignupSection({ formRef, onSuccess }: SignupSectionProps) {
  return (
    ...
    >
      ...
      <div className="max-w-[1200px] mx-auto grid lg:grid-cols-[1fr_1.05fr] gap-12 lg:gap-16 items-start">
        ...
        >
          <h2 className="font-sora font-bold text-[28px] md:text-[40px] leading-[1.1] text-brown-dark tracking-tight mb-7">
          ...
          <p className="italic text-muted text-[15px] md:text-[16px] leading-relaxed max-w-md">
        ...
        <motion.div
          ...
          viewport={{ once: true, margin: '-80px' }}
          transition={{ duration: 0.6, ease: [0.22, 1, 0.36, 1] }}
          className="bg-white rounded-card shadow-lift border border-brown-dark/8 p-6 md:p-8"
        >
